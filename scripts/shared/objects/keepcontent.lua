...
function smashContainer(objectType)
	...
	-- Frackin Universe BYOS
	if object.name() == "fu_byosshiplocker" then
		objParameters["placementImage"] = config.getParameter("placementImage")
		objParameters["imageConfig"] = config.getParameter("imageConfig")
		objParameters["placementImagePosition"] = config.getParameter("placementImagePosition")
	end
