...
require('/quests/scripts/conditions/gatherItemWithParameters.lua')
...
function buildConditions()
  ...
  for _,config in pairs(conditionConfig) do
    ...
    elseif config.type == "gatherItemWithParameters" then
      newCondition = buildGatherItemWithParametersCondition(config)
...
function questStart()
  ...
  if associatedMission then
	...
	player.giveBlueprint("filingcabinet")
end
